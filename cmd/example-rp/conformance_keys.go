...
func loadClientKeyProvider(authType string) (rp.ClientKeyProvider, error) {
	...
	case "private_key_jwt":
		return rp.NewStaticClientKeyProvider(keys.rsaPrivateKey, keys.rsaKeyID, keys.rsaAlg, nil), nil
	case "mtls":
